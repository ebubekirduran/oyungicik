...
public class Gicikd39 extends Activity implements FragmentManager.OnBackStackChangedListener {
	TextView l1,l2,l3,l4,l5,l6,l7,l8,l9,l0;
	  private Handler mHandler = new Handler();
	    private boolean mShowingBack = false;
	MediaPlayer yanlis;
	Button restart39,button1,button2,button3,button4,button5,button6,button7,button8,button9,button10,button11,button12,button13,button14,button15,button16,
...
//	ver
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.gicikd39);
...
//
		test39=(TextView)findViewById(R.id.test39);
			
		yanlis=MediaPlayer.create(Gicikd39.this,R.raw.yanlis);
		
		button1=(Button)findViewById(R.id.P2x1);
		button2=(Button)findViewById(R.id.P2x2);
		button3=(Button)findViewById(R.id.P2x3);
		button4=(Button)findViewById(R.id.P2x4);
		button5=(Button)findViewById(R.id.P2x5);
		button6=(Button)findViewById(R.id.P2x6);
		button7=(Button)findViewById(R.id.P2x7);
		button8=(Button)findViewById(R.id.P2x8);
		button9=(Button)findViewById(R.id.P2x9);
		button10=(Button)findViewById(R.id.P2x10);
		button11=(Button)findViewById(R.id.P2x11);
		button12=(Button)findViewById(R.id.P2x12);
		button13=(Button)findViewById(R.id.P2x13);
		button14=(Button)findViewById(R.id.P2x14);
		button15=(Button)findViewById(R.id.P2x15);
		button16=(Button)findViewById(R.id.P2x16);
		button17=(Button)findViewById(R.id.P2x17);
		button18=(Button)findViewById(R.id.P2x18);
		button19=(Button)findViewById(R.id.P2x19);
		button20=(Button)findViewById(R.id.P2x20);
		button21=(Button)findViewById(R.id.P2x21);
		button22=(Button)findViewById(R.id.P2x22);
		button23=(Button)findViewById(R.id.P2x23);
		button24=(Button)findViewById(R.id.P2x24);
		button25=(Button)findViewById(R.id.P2x25);
		button26=(Button)findViewById(R.id.P2x26);
		button27=(Button)findViewById(R.id.P2x27);
		button28=(Button)findViewById(R.id.P2x28);
		button29=(Button)findViewById(R.id.P2x29);
		button30=(Button)findViewById(R.id.P2x30);
		button31=(Button)findViewById(R.id.P2x31);
		button32=(Button)findViewById(R.id.P2x32);
		button33=(Button)findViewById(R.id.P2x33);
		button34=(Button)findViewById(R.id.P2x34);
		button35=(Button)findViewById(R.id.P2x35);
		button36=(Button)findViewById(R.id.P2x36);
...
//		zaman geri sayým
		  ...
		  Random r=new Random(); //random sýnýfý
	        ...
	        String gelensayi = a + "";				        
	        test39.setText(gelensayi);	
	        
	    	tscore39=(TextView)findViewById(R.id.score39);			 
	    	sharedPreference = new SharedPreference();
			topscore = sharedPreference.getValue(context);	
		    tscore39.setText(String.valueOf(topscore));

		    restart39=(Button)findViewById(R.id.restart39);
	        restart39.setOnClickListener(new View.OnClickListener() {			
	        	@Override
		       ...
		       Button back=(Button)findViewById(R.id.back39);
...
public void onClick(View v) {	
	...
	// 2.katman
		...
		sayac++;
		score39=score39+50;
		stopscore=score39+topscore+"";
		tscore39.setText(stopscore);
...
public void onClick(View v) {	
	...
	{
		týk16=1;
		button16.setBackgroundResource(R.drawable.besyuzyesil);
		score39=score39+30;
		stopscore=score39+topscore+"";
		tscore39.setText(stopscore);
		 if(sayac<36){
...
if(score39+topscore<0)
{
	...
	private void ScoreAl25() {
		topscore = Integer.parseInt(tscore39.getText().toString().trim());
		// Save the text in SharedPreference
	  	sharedPreference.save(context, topscore,39);
	  	// Save the text in SharedPreference
	    try {
	      Bundle extras = new Bundle();
	      extras.putInt(TOPSCORE, topscore);
