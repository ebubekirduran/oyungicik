...
public class Gicikd35 extends Activity implements FragmentManager.OnBackStackChangedListener {
	TextView l1,l2,l3,l4,l5,l6,l7,l8,l9,l0;
	  private Handler mHandler = new Handler();
	    private boolean mShowingBack = false;
	MediaPlayer yanlis;
	Button restart35,button1,button2,button3,button4,button5,button6,button7,button8,button9,button10,button11,button12,button13,button14,button15,button16,
...
//	ver
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.gicikd35);
...
//
		test35=(TextView)findViewById(R.id.test35);
			
		yanlis=MediaPlayer.create(Gicikd35.this,R.raw.yanlis);
		
		button1=(Button)findViewById(R.id.L2x1);
		button2=(Button)findViewById(R.id.L2x2);
		button3=(Button)findViewById(R.id.L2x3);
		button4=(Button)findViewById(R.id.L2x4);
		button5=(Button)findViewById(R.id.L2x5);
		button6=(Button)findViewById(R.id.L2x6);
		button7=(Button)findViewById(R.id.L2x7);
		button8=(Button)findViewById(R.id.L2x8);
		button9=(Button)findViewById(R.id.L2x9);
		button10=(Button)findViewById(R.id.L2x10);
		button11=(Button)findViewById(R.id.L2x11);
		button12=(Button)findViewById(R.id.L2x12);
		button13=(Button)findViewById(R.id.L2x13);
		button14=(Button)findViewById(R.id.L2x14);
		button15=(Button)findViewById(R.id.L2x15);
		button16=(Button)findViewById(R.id.L2x16);
		button17=(Button)findViewById(R.id.L2x17);
		button18=(Button)findViewById(R.id.L2x18);
		button19=(Button)findViewById(R.id.L2x19);
		button20=(Button)findViewById(R.id.L2x20);
		button21=(Button)findViewById(R.id.L2x21);
		button22=(Button)findViewById(R.id.L2x22);
		button23=(Button)findViewById(R.id.L2x23);
		button24=(Button)findViewById(R.id.L2x24);
		button25=(Button)findViewById(R.id.L2x25);
		button26=(Button)findViewById(R.id.L2x26);
		button27=(Button)findViewById(R.id.L2x27);
		button28=(Button)findViewById(R.id.L2x28);
		button29=(Button)findViewById(R.id.L2x29);
		button30=(Button)findViewById(R.id.L2x30);
...
//		zaman geri sayým
		  ...
		  Random r=new Random(); //random sýnýfý
	        ...
	        String gelensayi = a + "";				        
	        test35.setText(gelensayi);	
	        
	    	tscore35=(TextView)findViewById(R.id.score35);			 
	    	sharedPreference = new SharedPreference();
			topscore = sharedPreference.getValue(context);	
		    tscore35.setText(String.valueOf(topscore));

		    restart35=(Button)findViewById(R.id.restart35);
	        restart35.setOnClickListener(new View.OnClickListener() {			
	        	@Override
	        ...
	        //Ana menuye donus
		       Button back=(Button)findViewById(R.id.back35);
...
public void onClick(View v) {	
	...
	//fýrsat benzer 
		...
		sayac++;
		score35=score35+10;
		stopscore=score35+topscore+"";
		tscore35.setText(stopscore);
		...
		b30topdegeri--;
		 if(sayac<30){
			 ...
			 ScoreAl25();
				...
				{
						týk3=1;
						button3.setBackgroundResource(R.drawable.besyuzsarikatman);
						score35=score35+20;
						stopscore=score35+topscore+"";
						tscore35.setText(stopscore);
						 if(sayac<30){
...
public void onClick(View v) {	
	...
	{
			týk11=1;
			button11.setBackgroundResource(R.drawable.besyuzkatman);
			score35=score35+10;
			stopscore=score35+topscore+"";
			tscore35.setText(stopscore);
			 if(sayac<30){
...
public void onClick(View v) {	
	...
	//fýrsat benzer 1. katman
		...
		{
				týk12=1;
				button12.setBackgroundResource(R.drawable.besyuzkatman);
				score35=score35+10;
				stopscore=score35+topscore+"";
				tscore35.setText(stopscore);
				 if(sayac<30){
...
public void onClick(View v) {	
	...
	//fýrsat benzer 1. katman
		...
		{
			týk13=2;
			button13.setBackgroundResource(R.drawable.besyuzyesil);
			score35=score35+30;
			stopscore=score35+topscore+"";
			tscore35.setText(stopscore);
			 if(sayac<30){
		...
		{
				týk13=1;
				button13.setBackgroundResource(R.drawable.besyuzyesilkatman);
				score35=score35+30;
				stopscore=score35+topscore+"";
				tscore35.setText(stopscore);
				 if(sayac<30){
...
public void onClick(View v) {	
	...
	//fýrsat benzer 1. katman
		...
		{
				týk14=1;
				button14.setBackgroundResource(R.drawable.besyuzkatman);
				score35=score35+10;
				stopscore=score35+topscore+"";
				tscore35.setText(stopscore);
				 if(sayac<30){
...
public void onClick(View v) {	
	...
	//fýrsat benzer 1. katman
		...
		{
				týk15=1;
				button15.setBackgroundResource(R.drawable.besyuzkatman);
				score35=score35+10;
				stopscore=score35+topscore+"";
				tscore35.setText(stopscore);
				 if(sayac<30){
...
public void onClick(View v) {	
	...
	//fýrsat benzer 1. katman
		...
		{
				týk16=1;
				button16.setBackgroundResource(R.drawable.besyuzkatman);
				score35=score35+10;
				stopscore=score35+topscore+"";
				tscore35.setText(stopscore);
				 if(sayac<30){
...
public void onClick(View v) {
	...
	//fýrsat benzer 1. katman
		...
		{
				týk18=1;
				button18.setBackgroundResource(R.drawable.besyuzyesilkatman);
				score35=score35+30;
				stopscore=score35+topscore+"";
				tscore35.setText(stopscore);
				 if(sayac<30){
...
public void onClick(View v) {	
	...
	//fýrsat benzer 1. katman
		...
		{
				týk20=1;
				button20.setBackgroundResource(R.drawable.besyuzkatman);
				score35=score35+10;
				stopscore=score35+topscore+"";
				tscore35.setText(stopscore);
				 if(sayac<30){
...
public void onClick(View v) {	
	...
	{
		týk22=1;
		button22.setBackgroundResource(R.drawable.besyuz);
		score35=score35+10;
		stopscore=score35+topscore+"";
		tscore35.setText(stopscore);
		 if(sayac<30){
...
public void onClick(View v) {	
	...
	{
		týk24=1;
		button24.setBackgroundResource(R.drawable.besyuz);
		score35=score35+10;
		stopscore=score35+topscore+"";
		tscore35.setText(stopscore);
		 if(sayac<30){
...
public void onClick(View v) {
	...
	//fýrsat benzer 
		...
		{
			týk25=1;
			button25.setBackgroundResource(R.drawable.besyuz);
			score35=score35+10;
			stopscore=score35+topscore+"";
			tscore35.setText(stopscore);
			 if(sayac<30){
...
public void onClick(View v) {
	...
	//fýrsat benzer 
		...
		else if(a == b27topdegeri)
		{
			týk27=1;
			button27.setBackgroundResource(R.drawable.besyuz);
			score35=score35+10;
			stopscore=score35+topscore+"";
			tscore35.setText(stopscore);
			 if(sayac<30){
...
public void onClick(View v) {
	...
	//fýrsat benzer 
		...
		else if(a == b29topdegeri)
		{
			týk29=1;
			button29.setBackgroundResource(R.drawable.besyuz);
			score35=score35+10;
			stopscore=score35+topscore+"";
			tscore35.setText(stopscore);
			 if(sayac<30){
...
if(score35+topscore<0)
{
	...
	private void ScoreAl25() {
		topscore = Integer.parseInt(tscore35.getText().toString().trim());
		// Save the text in SharedPreference
	  	sharedPreference.save(context, topscore,35);
	  	// Save the text in SharedPreference
	    try {
	      Bundle extras = new Bundle();
	      extras.putInt(TOPSCORE, topscore);
