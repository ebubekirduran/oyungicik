...
public class Gicikf50 extends Activity implements FragmentManager.OnBackStackChangedListener{
	TextView l1,l2,l3,l4,l5,l6,l7,l8,l9,l0;
	 private Handler mHandler = new Handler();
	    private boolean mShowingBack = false;
	MediaPlayer yanlis;
	Button restart50,button1,button2,button3,button4,button5,button6,button7,button8,button9,button10,button11,button12,button13,button14,button15,button16,
...
//	ver
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.gicikf50);
...
//
		test50=(TextView)findViewById(R.id.test50);
			
		yanlis=MediaPlayer.create(Gicikf50.this,R.raw.yanlis);
		
		button1=(Button)findViewById(R.id.D3x1);
		button2=(Button)findViewById(R.id.D3x2);
		button3=(Button)findViewById(R.id.D3x3);
		button4=(Button)findViewById(R.id.D3x4);
		button5=(Button)findViewById(R.id.D3x5);
		button6=(Button)findViewById(R.id.D3x6);
		button7=(Button)findViewById(R.id.D3x7);
		button8=(Button)findViewById(R.id.D3x8);
		button9=(Button)findViewById(R.id.D3x9);
		button10=(Button)findViewById(R.id.D3x10);
		button11=(Button)findViewById(R.id.D3x11);
		button12=(Button)findViewById(R.id.D3x12);
		button13=(Button)findViewById(R.id.D3x13);
		button14=(Button)findViewById(R.id.D3x14);
		button15=(Button)findViewById(R.id.D3x15);
		button16=(Button)findViewById(R.id.D3x16);
		button17=(Button)findViewById(R.id.D3x17);
		button18=(Button)findViewById(R.id.D3x18);
		button19=(Button)findViewById(R.id.D3x19);
		button20=(Button)findViewById(R.id.D3x20);
		button21=(Button)findViewById(R.id.D3x21);
		button22=(Button)findViewById(R.id.D3x22);
		button23=(Button)findViewById(R.id.D3x23);
		button24=(Button)findViewById(R.id.D3x24);
		button25=(Button)findViewById(R.id.D3x25);
		button26=(Button)findViewById(R.id.D3x26);
		button27=(Button)findViewById(R.id.D3x27);
		button28=(Button)findViewById(R.id.D3x28);
		button29=(Button)findViewById(R.id.D3x29);
		button30=(Button)findViewById(R.id.D3x30);
		button31=(Button)findViewById(R.id.D3x31);
		button32=(Button)findViewById(R.id.D3x32);
		button33=(Button)findViewById(R.id.D3x33);
		button34=(Button)findViewById(R.id.D3x34);
		button35=(Button)findViewById(R.id.D3x35);
		button36=(Button)findViewById(R.id.D3x36);
		button37=(Button)findViewById(R.id.D3x37);
		button38=(Button)findViewById(R.id.D3x38);
		button39=(Button)findViewById(R.id.D3x39);
		button40=(Button)findViewById(R.id.D3x40);
		button41=(Button)findViewById(R.id.D3x41);
		button42=(Button)findViewById(R.id.D3x42);
...
//		zaman geri sayým
		  ...
		  Random r=new Random(); //random sýnýfý
	        ...
	        String gelensayi = a + "";				        
	        test50.setText(gelensayi);	
	        
	    	tscore50=(TextView)findViewById(R.id.score50);			 
	    	sharedPreference = new SharedPreference();
			topscore = sharedPreference.getValue(context);	
		    tscore50.setText(String.valueOf(topscore));

		    restart50=(Button)findViewById(R.id.restart50);
	        restart50.setOnClickListener(new View.OnClickListener() {			
	        	@Override
	      ...
	      //Ana menuye donus
		       Button back=(Button)findViewById(R.id.back50);
	        ...
	        button1.setOnClickListener(new View.OnClickListener() {			
	        	...
	        	public void onClick(View v) {	
	        		...
	        		if(týk1==4 && a == b1topdegeri){
	        			sayac++;
	        			score50=score50+50;
	        			stopscore=score50+topscore+"";
	        			tscore50.setText(stopscore);
	        		...
	        		{
	        			týk1=3;
	        			button1.setBackgroundResource(R.drawable.besyuzturuncu);
	        			score50=score50+100;
	        			stopscore=score50+topscore+"";
	        			tscore50.setText(stopscore);
	        			 if(sayac<42){
	        		...
	        		{
	        			týk1=2;
	        			button1.setBackgroundResource(R.drawable.besyuzturuncukatman);
	        			score50=score50+100;
	        			stopscore=score50+topscore+"";
	        			tscore50.setText(stopscore);
	        			 if(sayac<42){
	        		...
	        		{
	        				týk1=1;
	        				button1.setBackgroundResource(R.drawable.besyuzturuncukatman2);
	        				score50=score50+100;
	        				stopscore=score50+topscore+"";
	        				tscore50.setText(stopscore);
	        				 if(sayac<42){
	        	...
	        	public void onClick(View v) {	
	        		...
	        		// 2.katman
	        			...
	        			{
	        				týk3=3;
	        				button3.setBackgroundResource(R.drawable.besyuzturuncu);
	        				score50=score50+100;
	        				stopscore=score50+topscore+"";
	        				tscore50.setText(stopscore);
	        				 if(sayac<42){
	        			...
	        			{
	        				týk3=2;
	        				button3.setBackgroundResource(R.drawable.besyuzturuncukatman);
	        				score50=score50+100;
	        				stopscore=score50+topscore+"";
	        				tscore50.setText(stopscore);
	        				 if(sayac<42){
	        			...
	        			{
	        					týk3=1;
	        					button3.setBackgroundResource(R.drawable.besyuzturuncukatman2);
	        					score50=score50+100;
	        					stopscore=score50+topscore+"";
	        					tscore50.setText(stopscore);
	        					 if(sayac<42){
	        				...
	        				if(týk4==4 && a == b4topdegeri)
	        		{
	        			...
	        			b42topdegeri--;
	        			 if(sayac<42){
	        				...
	        				{
	        					týk4=3;
	        					button4.setBackgroundResource(R.drawable.besyuzturuncu);
	        					score50=score50+100;
	        					stopscore=score50+topscore+"";
	        					tscore50.setText(stopscore);
	        					 if(sayac<42){
	        				...
	        				{
	        					týk4=2;
	        					button4.setBackgroundResource(R.drawable.besyuzturuncukatman);
	        					score50=score50+100;
	        					stopscore=score50+topscore+"";
	        					tscore50.setText(stopscore);
	        					 if(sayac<42){
	        				...
	        				{
	        						týk4=1;
	        						button4.setBackgroundResource(R.drawable.besyuzturuncukatman2);
	        						score50=score50+100;
	        						stopscore=score50+topscore+"";
	        						tscore50.setText(stopscore);
	        						 if(sayac<42){
	        	...
	        	public void onClick(View v) {	
	        		...
	        		// 2.katman
	        			...
	        			//fýrsat benzer 1. katman
	        					...
	        					{
	        							týk6=1;
	        							button6.setBackgroundResource(R.drawable.besyuzturuncukatman2);
	        							score50=score50+100;
	        							stopscore=score50+topscore+"";
	        							tscore50.setText(stopscore);
	        							 if(sayac<42){
	        	...
	        	public void onClick(View v) {	
	        		...
	        		// 2.katman
	        			...
	        			//fýrsat benzer 1. katman
	        					...
	        					{
	        						týk7=3;
	        						button7.setBackgroundResource(R.drawable.besyuzturuncu);
	        						score50=score50+100;
	        						stopscore=score50+topscore+"";
	        						tscore50.setText(stopscore);
	        						 if(sayac<42){
	        					...
	        					{
	        						týk7=2;
	        						button7.setBackgroundResource(R.drawable.besyuzturuncukatman);
	        						score50=score50+100;
	        						stopscore=score50+topscore+"";
	        						tscore50.setText(stopscore);
	        						 if(sayac<42){
	        					...
	        					{
	        							týk7=1;
	        							button7.setBackgroundResource(R.drawable.besyuzturuncukatman2);
	        							score50=score50+100;
	        							stopscore=score50+topscore+"";
	        							tscore50.setText(stopscore);
	        							 if(sayac<42){
	        	...
	        	public void onClick(View v) {	
	        		...
	        		// 2.katman
	        			...
	        			//fýrsat benzer 1. katman
	        					...
	        					{
	        						týk9=3;
	        						button9.setBackgroundResource(R.drawable.besyuzturuncu);
	        						score50=score50+100;
	        						stopscore=score50+topscore+"";
	        						tscore50.setText(stopscore);
	        						 if(sayac<42){
	        					...
	        					{
	        						týk9=2;
	        						button9.setBackgroundResource(R.drawable.besyuzturuncukatman);
	        						score50=score50+100;
	        						stopscore=score50+topscore+"";
	        						tscore50.setText(stopscore);
	        						 if(sayac<42){
	        					...
	        					{
	        							týk9=1;
	        							button9.setBackgroundResource(R.drawable.besyuzturuncukatman2);
	        							score50=score50+100;
	        							stopscore=score50+topscore+"";
	        							tscore50.setText(stopscore);
	        							 if(sayac<42){
	        	...
	        	public void onClick(View v) {
	        		...
	        		// 2.katman
	        			...
	        			//fýrsat benzer 1. katman
	        					...
	        					{
	        						týk10=3;
	        						button10.setBackgroundResource(R.drawable.besyuzturuncu);
	        						score50=score50+100;
	        						stopscore=score50+topscore+"";
	        						tscore50.setText(stopscore);
	        						 if(sayac<42){
	        					...
	        					{
	        						týk10=2;
	        						button10.setBackgroundResource(R.drawable.besyuzturuncukatman);
	        						score50=score50+100;
	        						stopscore=score50+topscore+"";
	        						tscore50.setText(stopscore);
	        						 if(sayac<42){
	        					...
	        					{
	        							týk10=1;
	        							button10.setBackgroundResource(R.drawable.besyuzturuncukatman2);
	        							score50=score50+100;
	        							stopscore=score50+topscore+"";
	        							tscore50.setText(stopscore);
	        							 if(sayac<42){
	        		...
	        		// 2.katman
	        			...
	        			b42topdegeri--;
	        			 if(sayac<42){
	        				...
	        				{
	        						týk12=1;
	        						button12.setBackgroundResource(R.drawable.besyuzturuncukatman2);
	        						score50=score50+100;
	        						stopscore=score50+topscore+"";
	        						tscore50.setText(stopscore);
	        						 if(sayac<42){
	        		...
	        		// 2.katman
	        			...
	        			b42topdegeri--;
	        			 if(sayac<42){
	        				...
	        				{
	        					týk13=2;
	        					button13.setBackgroundResource(R.drawable.besyuzturuncukatman);
	        					score50=score50+100;
	        					stopscore=score50+topscore+"";
	        					tscore50.setText(stopscore);
	        					 if(sayac<42){
	        				...
	        				{
	        						týk13=1;
	        						button13.setBackgroundResource(R.drawable.besyuzturuncukatman2);
	        						score50=score50+100;
	        						stopscore=score50+topscore+"";
	        						tscore50.setText(stopscore);
	        						 if(sayac<42){
	        		...
	        		// 2.katman
	        			...
	        			b42topdegeri--;
	        			 if(sayac<42){
	        				...
	        				{
	        					týk18=2;
	        					button18.setBackgroundResource(R.drawable.besyuzturuncukatman);
	        					score50=score50+100;
	        					stopscore=score50+topscore+"";
	        					tscore50.setText(stopscore);
	        					 if(sayac<42){
	        				...
	        				{
	        						týk18=1;
	        						button18.setBackgroundResource(R.drawable.besyuzturuncukatman2);
	        						score50=score50+100;
	        						stopscore=score50+topscore+"";
	        						tscore50.setText(stopscore);
	        						 if(sayac<42){
	        		...
	        		// 2.katman
	        			...
	        			b42topdegeri--;
	        			 if(sayac<42){
	        				...
	        				{
	        					týk19=2;
	        					button19.setBackgroundResource(R.drawable.besyuzturuncukatman);
	        					score50=score50+100;
	        					stopscore=score50+topscore+"";
	        					tscore50.setText(stopscore);
	        					 if(sayac<42){
	        				...
	        				{
	        						týk19=1;
	        						button19.setBackgroundResource(R.drawable.besyuzturuncukatman2);
	        						score50=score50+100;
	        						stopscore=score50+topscore+"";
	        						tscore50.setText(stopscore);
	        						 if(sayac<42){
	        		...
	        		// 2.katman
	        			...
	        			b42topdegeri--;
	        			 if(sayac<42){
	        				...
	        				{
	        					týk20=3;
	        					button20.setBackgroundResource(R.drawable.besyuzturuncu);
	        					score50=score50+100;
	        					stopscore=score50+topscore+"";
	        					tscore50.setText(stopscore);
	        					 if(sayac<42){
	        				...
	        				{
	        					týk20=2;
	        					button20.setBackgroundResource(R.drawable.besyuzturuncukatman);
	        					score50=score50+100;
	        					stopscore=score50+topscore+"";
	        					tscore50.setText(stopscore);
	        					 if(sayac<42){
	        				...
	        				{
	        						týk20=1;
	        						button20.setBackgroundResource(R.drawable.besyuzturuncukatman2);
	        						score50=score50+100;
	        						stopscore=score50+topscore+"";
	        						tscore50.setText(stopscore);
	        						 if(sayac<42){
	        		...
	        		// 2.katman
	        			...
	        			b42topdegeri--;
	        			 if(sayac<42){
	        				...
	        				{
	        						týk21=1;
	        						button21.setBackgroundResource(R.drawable.besyuzturuncukatman2);
	        						score50=score50+100;
	        						stopscore=score50+topscore+"";
	        						tscore50.setText(stopscore);
	        						 if(sayac<42){
	        			...
	        			b42topdegeri--;
	        			 if(sayac<42){
	        				 ...
	        				 ScoreAl25();
	        					...
	        					{
	        							týk22=1;
	        							button22.setBackgroundResource(R.drawable.besyuzturuncukatman2);
	        							score50=score50+100;
	        							stopscore=score50+topscore+"";
	        							tscore50.setText(stopscore);
	        							 if(sayac<42){
	        			...
	        			b42topdegeri--;
	        			 if(sayac<42){
	        				 ...
	        				 ScoreAl25();
	        					...
	        					{
	        						týk23=3;
	        						button23.setBackgroundResource(R.drawable.besyuzturuncu);
	        						score50=score50+100;
	        						stopscore=score50+topscore+"";
	        						tscore50.setText(stopscore);
	        						 if(sayac<42){
	        					...
	        					{
	        						týk23=2;
	        						button23.setBackgroundResource(R.drawable.besyuzturuncukatman);
	        						score50=score50+100;
	        						stopscore=score50+topscore+"";
	        						tscore50.setText(stopscore);
	        						 if(sayac<42){
	        					...
	        					{
	        							týk23=1;
	        							button23.setBackgroundResource(R.drawable.besyuzturuncukatman2);
	        							score50=score50+100;
	        							stopscore=score50+topscore+"";
	        							tscore50.setText(stopscore);
	        							 if(sayac<42){
	        			...
	        			b42topdegeri--;
	        			 if(sayac<42){
	        				 ...
	        				 ScoreAl25();
	        					...
	        					{
	        						týk24=2;
	        						button24.setBackgroundResource(R.drawable.besyuzturuncukatman);
	        						score50=score50+100;
	        						stopscore=score50+topscore+"";
	        						tscore50.setText(stopscore);
	        						 if(sayac<42){
	        					...
	        					{
	        							týk24=1;
	        							button24.setBackgroundResource(R.drawable.besyuzturuncukatman2);
	        							score50=score50+100;
	        							stopscore=score50+topscore+"";
	        							tscore50.setText(stopscore);
	        							 if(sayac<42){
	        			...
	        			b42topdegeri--;
	        			 ...
	        			 if(sayac<42){
	        				 ...
	        				 ScoreAl25();
	        					...
	        					{
	        						týk25=2;
	        						button25.setBackgroundResource(R.drawable.besyuzturuncukatman);
	        						score50=score50+100;
	        						stopscore=score50+topscore+"";
	        						tscore50.setText(stopscore);
	        						 if(sayac<42){
	        					...
	        					{
	        							týk25=1;
	        							button25.setBackgroundResource(R.drawable.besyuzturuncukatman2);
	        							score50=score50+100;
	        							stopscore=score50+topscore+"";
	        							tscore50.setText(stopscore);
	        							 if(sayac<42){
	        			...
	        			b42topdegeri--;
	        			 ...
	        			 if(sayac<42){
	        				 ...
	        				 ScoreAl25();
	        					...
	        					{
	        							týk30=1;
	        							button30.setBackgroundResource(R.drawable.besyuzturuncukatman2);
	        							score50=score50+100;
	        							stopscore=score50+topscore+"";
	        							tscore50.setText(stopscore);
	        							 if(sayac<42){
	        	...
	        	public void onClick(View v) {
	        		...
	        		{
	        			týk31=3;
	        			button31.setBackgroundResource(R.drawable.besyuzturuncu);
	        			score50=score50+100;
	        			stopscore=score50+topscore+"";
	        			tscore50.setText(stopscore);
	        			 if(sayac<42){
	        		...
	        		{
	        			týk31=2;
	        			button31.setBackgroundResource(R.drawable.besyuzturuncukatman);
	        			score50=score50+100;
	        			stopscore=score50+topscore+"";
	        			tscore50.setText(stopscore);
	        			 if(sayac<42){
	        		...
	        		{
	        				týk31=1;
	        				button31.setBackgroundResource(R.drawable.besyuzturuncukatman2);
	        				score50=score50+100;
	        				stopscore=score50+topscore+"";
	        				tscore50.setText(stopscore);
	        				 if(sayac<42){
	        	...
	        	public void onClick(View v) {
	        		...
	        		{
	        			týk33=3;
	        			button33.setBackgroundResource(R.drawable.besyuzturuncu);
	        			score50=score50+100;
	        			stopscore=score50+topscore+"";
	        			tscore50.setText(stopscore);
	        			 if(sayac<42){
	        		...
	        		{
	        			týk33=2;
	        			button33.setBackgroundResource(R.drawable.besyuzturuncukatman);
	        			score50=score50+100;
	        			stopscore=score50+topscore+"";
	        			tscore50.setText(stopscore);
	        			 if(sayac<42){
	        		...
	        		{
	        				týk33=1;
	        				button33.setBackgroundResource(R.drawable.besyuzturuncukatman2);
	        				score50=score50+100;
	        				stopscore=score50+topscore+"";
	        				tscore50.setText(stopscore);
	        				 if(sayac<42){
	        	...
	        	public void onClick(View v) {
	        		...
	        		{
	        			týk34=3;
	        			button34.setBackgroundResource(R.drawable.besyuzturuncu);
	        			score50=score50+100;
	        			stopscore=score50+topscore+"";
	        			tscore50.setText(stopscore);
	        			 if(sayac<42){
	        		...
	        		{
	        			týk34=2;
	        			button34.setBackgroundResource(R.drawable.besyuzturuncukatman);
	        			score50=score50+100;
	        			stopscore=score50+topscore+"";
	        			tscore50.setText(stopscore);
	        			 if(sayac<42){
	        		...
	        		{
	        				týk34=1;
	        				button34.setBackgroundResource(R.drawable.besyuzturuncukatman2);
	        				score50=score50+100;
	        				stopscore=score50+topscore+"";
	        				tscore50.setText(stopscore);
	        				 if(sayac<42){
	        	...
	        	public void onClick(View v) {
	        		...
	        		{
	        				týk36=1;
	        				button36.setBackgroundResource(R.drawable.besyuzturuncukatman2);
	        				score50=score50+100;
	        				stopscore=score50+topscore+"";
	        				tscore50.setText(stopscore);
	        				 if(sayac<42){
	        	...
	        	public void onClick(View v) {
	        		...
	        		{
	        			týk37=3;
	        			button37.setBackgroundResource(R.drawable.besyuzturuncu);
	        			score50=score50+100;
	        			stopscore=score50+topscore+"";
	        			tscore50.setText(stopscore);
	        			 if(sayac<42){
	        		...
	        		{
	        			týk37=2;
	        			button37.setBackgroundResource(R.drawable.besyuzturuncukatman);
	        			score50=score50+100;
	        			stopscore=score50+topscore+"";
	        			tscore50.setText(stopscore);
	        			 if(sayac<42){
	        		...
	        		{
	        				týk37=1;
	        				button37.setBackgroundResource(R.drawable.besyuzturuncukatman2);
	        				score50=score50+100;
	        				stopscore=score50+topscore+"";
	        				tscore50.setText(stopscore);
	        				 if(sayac<42){
	        	...
	        	public void onClick(View v) {
	        		...
	        		{
	        			týk39=3;
	        			button39.setBackgroundResource(R.drawable.besyuzturuncu);
	        			score50=score50+100;
	        			stopscore=score50+topscore+"";
	        			tscore50.setText(stopscore);
	        			 if(sayac<42){
	        		...
	        		{
	        			týk39=2;
	        			button39.setBackgroundResource(R.drawable.besyuzturuncukatman);
	        			score50=score50+100;
	        			stopscore=score50+topscore+"";
	        			tscore50.setText(stopscore);
	        			 if(sayac<42){
	        		...
	        		{
	        				týk39=1;
	        				button39.setBackgroundResource(R.drawable.besyuzturuncukatman2);
	        				score50=score50+100;
	        				stopscore=score50+topscore+"";
	        				tscore50.setText(stopscore);
	        				 if(sayac<42){
	        	...
	        	public void onClick(View v) {
	        		...
	        		{
	        			týk40=3;
	        			button40.setBackgroundResource(R.drawable.besyuzturuncu);
	        			score50=score50+100;
	        			stopscore=score50+topscore+"";
	        			tscore50.setText(stopscore);
	        			 if(sayac<42){
	        		...
	        		{
	        			týk40=2;
	        			button40.setBackgroundResource(R.drawable.besyuzturuncukatman);
	        			score50=score50+100;
	        			stopscore=score50+topscore+"";
	        			tscore50.setText(stopscore);
	        			 if(sayac<42){
	        		...
	        		{
	        				týk40=1;
	        				button40.setBackgroundResource(R.drawable.besyuzturuncukatman2);
	        				score50=score50+100;
	        				stopscore=score50+topscore+"";
	        				tscore50.setText(stopscore);
	        				 if(sayac<42){
	        	...
	        	public void onClick(View v) {
	        		...
	        		// 2.katman
	        			...
	        			{
	        					týk42=1;
	        					button42.setBackgroundResource(R.drawable.besyuzturuncukatman2);
	        					score50=score50+100;
	        					stopscore=score50+topscore+"";
	        					tscore50.setText(stopscore);
	        					 if(sayac<42){
...
if(score50+topscore<0)
{
	...
	private void ScoreAl25() {
		topscore = Integer.parseInt(tscore50.getText().toString().trim());
		// Save the text in SharedPreference
	  	sharedPreference.save(context, topscore,50);
	  	// Save the text in SharedPreference
	    try {
	      Bundle extras = new Bundle();
	      extras.putInt(TOPSCORE, topscore);
