...
public class Gicike43 extends Activity implements FragmentManager.OnBackStackChangedListener {
	TextView l1,l2,l3,l4,l5,l6,l7,l8,l9,l0;
	  private Handler mHandler = new Handler();
	    private boolean mShowingBack = false;
	MediaPlayer yanlis;
	Button restart43,button1,button2,button3,button4,button5,button6,button7,button8,button9,button10,button11,button12,button13,button14,button15,button16,
...
//	ver
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.gicike43);
...
//
		test43=(TextView)findViewById(R.id.test43);
			
		yanlis=MediaPlayer.create(Gicike43.this,R.raw.yanlis);
		
		button1=(Button)findViewById(R.id.U2x1);
		button2=(Button)findViewById(R.id.U2x2);
		button3=(Button)findViewById(R.id.U2x3);
		button4=(Button)findViewById(R.id.U2x4);
		button5=(Button)findViewById(R.id.U2x5);
		button6=(Button)findViewById(R.id.U2x6);
		button7=(Button)findViewById(R.id.U2x7);
		button8=(Button)findViewById(R.id.U2x8);
		button9=(Button)findViewById(R.id.U2x9);
		button10=(Button)findViewById(R.id.U2x10);
		button11=(Button)findViewById(R.id.U2x11);
		button12=(Button)findViewById(R.id.U2x12);
		button13=(Button)findViewById(R.id.U2x13);
		button14=(Button)findViewById(R.id.U2x14);
		button15=(Button)findViewById(R.id.U2x15);
		button16=(Button)findViewById(R.id.U2x16);
		button17=(Button)findViewById(R.id.U2x17);
		button18=(Button)findViewById(R.id.U2x18);
		button19=(Button)findViewById(R.id.U2x19);
		button20=(Button)findViewById(R.id.U2x20);
		button21=(Button)findViewById(R.id.U2x21);
		button22=(Button)findViewById(R.id.U2x22);
		button23=(Button)findViewById(R.id.U2x23);
		button24=(Button)findViewById(R.id.U2x24);
		button25=(Button)findViewById(R.id.U2x25);
		button26=(Button)findViewById(R.id.U2x26);
		button27=(Button)findViewById(R.id.U2x27);
		button28=(Button)findViewById(R.id.U2x28);
		button29=(Button)findViewById(R.id.U2x29);
		button30=(Button)findViewById(R.id.U2x30);
		button31=(Button)findViewById(R.id.U2x31);
		button32=(Button)findViewById(R.id.U2x32);
		button33=(Button)findViewById(R.id.U2x33);
		button34=(Button)findViewById(R.id.U2x34);
		button35=(Button)findViewById(R.id.U2x35);
		button36=(Button)findViewById(R.id.U2x36);
		button37=(Button)findViewById(R.id.U2x37);
		button38=(Button)findViewById(R.id.U2x38);
		button39=(Button)findViewById(R.id.U2x39);
		button40=(Button)findViewById(R.id.U2x40);
		button41=(Button)findViewById(R.id.U2x41);
		button42=(Button)findViewById(R.id.U2x42);
...
//		zaman geri sayým
		  ...
		  Random r=new Random(); //random sýnýfý
	        ...
	        String gelensayi = a + "";				        
	        test43.setText(gelensayi);	
	        
	    	tscore43=(TextView)findViewById(R.id.score43);			 
	    	sharedPreference = new SharedPreference();
			topscore = sharedPreference.getValue(context);	
		    tscore43.setText(String.valueOf(topscore));

		    restart43=(Button)findViewById(R.id.restart43);
	        restart43.setOnClickListener(new View.OnClickListener() {			
	        	@Override
	      ...
	      //Ana menuye donus
		       Button back=(Button)findViewById(R.id.back43);
...
public void onClick(View v) {	
	...
	if(týk1==3 && a == b1topdegeri){
		sayac++;
		score43=score43+50;
		stopscore=score43+topscore+"";
		tscore43.setText(stopscore);
	...
	// 2.katman
		...
		b42topdegeri--;
		 ...
		 if(sayac<42){
			...
			{
				týk25=2;
				button25.setBackgroundResource(R.drawable.besyuzsari);
				score43=score43+20;
				stopscore=score43+topscore+"";
				tscore43.setText(stopscore);
				 if(sayac<42){
			...
			{
					týk25=1;
					button25.setBackgroundResource(R.drawable.besyuzsarikatman);
					score43=score43+20;
					stopscore=score43+topscore+"";
					tscore43.setText(stopscore);
					 if(sayac<42){
	...
	// 2.katman
		...
		b42topdegeri--;
		 ...
		 if(sayac<42){
			...
			{
				týk32=2;
				button32.setBackgroundResource(R.drawable.besyuzsari);
				score43=score43+20;
				stopscore=score43+topscore+"";
				tscore43.setText(stopscore);
				 if(sayac<42){
			...
			{
					týk32=1;
					button32.setBackgroundResource(R.drawable.besyuzsarikatman);
					score43=score43+20;
					stopscore=score43+topscore+"";
					tscore43.setText(stopscore);
					 if(sayac<42){
		...
		b42topdegeri--;
		 if(sayac<42){
			 ...
			 ScoreAl25();
				...
				{
					týk39=2;
					button39.setBackgroundResource(R.drawable.besyuzsari);
					score43=score43+20;
					stopscore=score43+topscore+"";
					tscore43.setText(stopscore);
					 if(sayac<42){
				...
				{
						týk39=1;
						button39.setBackgroundResource(R.drawable.besyuzsarikatman);
						score43=score43+20;
						stopscore=score43+topscore+"";
						tscore43.setText(stopscore);
						 if(sayac<42){
...
if(score43+topscore<0)
{
	...
	private void ScoreAl25() {
		topscore = Integer.parseInt(tscore43.getText().toString().trim());
		// Save the text in SharedPreference
	  	sharedPreference.save(context, topscore,43);
	  	// Save the text in SharedPreference
	    try {
	      Bundle extras = new Bundle();
	      extras.putInt(TOPSCORE, topscore);
