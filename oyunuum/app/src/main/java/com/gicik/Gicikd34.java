...
public class Gicikd34 extends Activity implements FragmentManager.OnBackStackChangedListener {
	TextView l1,l2,l3,l4,l5,l6,l7,l8,l9,l0;
	  private Handler mHandler = new Handler();
	    private boolean mShowingBack = false;
	MediaPlayer yanlis;
	Button restart34,button1,button2,button3,button4,button5,button6,button7,button8,button9,button10,button11,button12,button13,button14,button15,button16,
...
//	ver
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.gicikd34);
...
//
		test34=(TextView)findViewById(R.id.test34);
			
		yanlis=MediaPlayer.create(Gicikd34.this,R.raw.yanlis);
		
		button1=(Button)findViewById(R.id.K2x1);
		button2=(Button)findViewById(R.id.K2x2);
		button3=(Button)findViewById(R.id.K2x3);
		button4=(Button)findViewById(R.id.K2x4);
		button5=(Button)findViewById(R.id.K2x5);
		button6=(Button)findViewById(R.id.K2x6);
		button7=(Button)findViewById(R.id.K2x7);
		button8=(Button)findViewById(R.id.K2x8);
		button9=(Button)findViewById(R.id.K2x9);
		button10=(Button)findViewById(R.id.K2x10);
		button11=(Button)findViewById(R.id.K2x11);
		button12=(Button)findViewById(R.id.K2x12);
		button13=(Button)findViewById(R.id.K2x13);
		button14=(Button)findViewById(R.id.K2x14);
		button15=(Button)findViewById(R.id.K2x15);
		button16=(Button)findViewById(R.id.K2x16);
		button17=(Button)findViewById(R.id.K2x17);
		button18=(Button)findViewById(R.id.K2x18);
		button19=(Button)findViewById(R.id.K2x19);
		button20=(Button)findViewById(R.id.K2x20);
		button21=(Button)findViewById(R.id.K2x21);
		button22=(Button)findViewById(R.id.K2x22);
		button23=(Button)findViewById(R.id.K2x23);
		button24=(Button)findViewById(R.id.K2x24);
		button25=(Button)findViewById(R.id.K2x25);
		button26=(Button)findViewById(R.id.K2x26);
		button27=(Button)findViewById(R.id.K2x27);
		button28=(Button)findViewById(R.id.K2x28);
		button29=(Button)findViewById(R.id.K2x29);
		button30=(Button)findViewById(R.id.K2x30);
...
//		zaman geri sayým
		  ...
		  Random r=new Random(); //random sýnýfý
	        ...
	        String gelensayi = a + "";				        
	        test34.setText(gelensayi);	
	        
	    	tscore34=(TextView)findViewById(R.id.score34);			 
	    	sharedPreference = new SharedPreference();
			topscore = sharedPreference.getValue(context);	
		    tscore34.setText(String.valueOf(topscore));

		    restart34=(Button)findViewById(R.id.restart34);
	        restart34.setOnClickListener(new View.OnClickListener() {			
	        	@Override
		       ...
		       Button back=(Button)findViewById(R.id.back34);
...
public void onClick(View v) {	
	...
	if(a == b1topdegeri)
	{
		sayac++;
		score34=score34+10;
		stopscore=score34+topscore+"";
		tscore34.setText(stopscore);
	...
	// 2.katman
		...
		b30topdegeri--;
		 if(sayac<30){
			...
			{
					týk3=1;
					button3.setBackgroundResource(R.drawable.besyuzkatman);
					score34=score34+10;
					stopscore=score34+topscore+"";
					tscore34.setText(stopscore);
					 if(sayac<30){
		...
		b30topdegeri--;
		 if(sayac<30){
			 ...
			 ScoreAl25();
				...
				{
						týk8=1;
						button8.setBackgroundResource(R.drawable.besyuzkatman);
						score34=score34+10;
						stopscore=score34+topscore+"";
						tscore34.setText(stopscore);
						 if(sayac<30){
...
public void onClick(View v) {	
	...
	//fýrsat benzer 1. katman
		...
		{
			týk17=2;
			button17.setBackgroundResource(R.drawable.besyuzsari);
			score34=score34+20;
			stopscore=score34+topscore+"";
			tscore34.setText(stopscore);
			 if(sayac<30){
		...
		{
				týk17=1;
				button17.setBackgroundResource(R.drawable.besyuzsarikatman);
				score34=score34+20;
				stopscore=score34+topscore+"";
				tscore34.setText(stopscore);
				 if(sayac<30){
...
public void onClick(View v) {
	...
	//fýrsat benzer 1. katman
		...
		{
			týk19=2;
			button19.setBackgroundResource(R.drawable.besyuzsari);
			score34=score34+20;
			stopscore=score34+topscore+"";
			tscore34.setText(stopscore);
			 if(sayac<30){
		...
		{
				týk19=1;
				button19.setBackgroundResource(R.drawable.besyuzsarikatman);
				score34=score34+20;
				stopscore=score34+topscore+"";
				tscore34.setText(stopscore);
				 if(sayac<30){
...
public void onClick(View v) {
	...
	// 2.katman
		...
		{
			týk26=2;
			button26.setBackgroundResource(R.drawable.besyuzyesil);
			score34=score34+30;
			stopscore=score34+topscore+"";
			tscore34.setText(stopscore);
			 if(sayac<30){
		...
		{
				týk26=1;
				button26.setBackgroundResource(R.drawable.besyuzyesilkatman);
				score34=score34+30;
				stopscore=score34+topscore+"";
				tscore34.setText(stopscore);
				 if(sayac<30){
...
public void onClick(View v) {
	...
	// 2.katman
		...
		//fýrsat benzer 1. katman
				...
				{
					týk28=2;
					button28.setBackgroundResource(R.drawable.besyuzyesil);
					score34=score34+30;
					stopscore=score34+topscore+"";
					tscore34.setText(stopscore);
					 if(sayac<30){
				...
				{
						týk28=1;
						button28.setBackgroundResource(R.drawable.besyuzyesilkatman);
						score34=score34+30;
						stopscore=score34+topscore+"";
						tscore34.setText(stopscore);
						 if(sayac<30){
...
public void onClick(View v) {
	...
	// 2.katman
		...
		//fýrsat benzer 1. katman
				...
				{
					týk30=2;
					button30.setBackgroundResource(R.drawable.besyuzyesil);
					score34=score34+30;
					stopscore=score34+topscore+"";
					tscore34.setText(stopscore);
					 if(sayac<30){
				...
				{
						týk30=1;
						button30.setBackgroundResource(R.drawable.besyuzyesilkatman);
						score34=score34+30;
						stopscore=score34+topscore+"";
						tscore34.setText(stopscore);
						 if(sayac<30){
...
if(score34+topscore<0)
{
	...
	private void ScoreAl25() {
		topscore = Integer.parseInt(tscore34.getText().toString().trim());
		// Save the text in SharedPreference
	  	sharedPreference.save(context, topscore,34);
	  	// Save the text in SharedPreference
	    try {
	      Bundle extras = new Bundle();
	      extras.putInt(TOPSCORE, topscore);
