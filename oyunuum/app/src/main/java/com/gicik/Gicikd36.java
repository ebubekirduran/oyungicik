...
public class Gicikd36 extends Activity implements FragmentManager.OnBackStackChangedListener {
	TextView l1,l2,l3,l4,l5,l6,l7,l8,l9,l0;
	  private Handler mHandler = new Handler();
	    private boolean mShowingBack = false;
	MediaPlayer yanlis;
	Button restart36,button1,button2,button3,button4,button5,button6,button7,button8,button9,button10,button11,button12,button13,button14,button15,button16,
...
//	ver
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.gicikd36);
...
//
		test36=(TextView)findViewById(R.id.test36);
			
		yanlis=MediaPlayer.create(Gicikd36.this,R.raw.yanlis);
		
		button1=(Button)findViewById(R.id.M2x1);
		button2=(Button)findViewById(R.id.M2x2);
		button3=(Button)findViewById(R.id.M2x3);
		button4=(Button)findViewById(R.id.M2x4);
		button5=(Button)findViewById(R.id.M2x5);
		button6=(Button)findViewById(R.id.M2x6);
		button7=(Button)findViewById(R.id.M2x7);
		button8=(Button)findViewById(R.id.M2x8);
		button9=(Button)findViewById(R.id.M2x9);
		button10=(Button)findViewById(R.id.M2x10);
		button11=(Button)findViewById(R.id.M2x11);
		button12=(Button)findViewById(R.id.M2x12);
		button13=(Button)findViewById(R.id.M2x13);
		button14=(Button)findViewById(R.id.M2x14);
		button15=(Button)findViewById(R.id.M2x15);
		button16=(Button)findViewById(R.id.M2x16);
		button17=(Button)findViewById(R.id.M2x17);
		button18=(Button)findViewById(R.id.M2x18);
		button19=(Button)findViewById(R.id.M2x19);
		button20=(Button)findViewById(R.id.M2x20);
		button21=(Button)findViewById(R.id.M2x21);
		button22=(Button)findViewById(R.id.M2x22);
		button23=(Button)findViewById(R.id.M2x23);
		button24=(Button)findViewById(R.id.M2x24);
		button25=(Button)findViewById(R.id.M2x25);
		button26=(Button)findViewById(R.id.M2x26);
		button27=(Button)findViewById(R.id.M2x27);
		button28=(Button)findViewById(R.id.M2x28);
		button29=(Button)findViewById(R.id.M2x29);
		button30=(Button)findViewById(R.id.M2x30);
		button31=(Button)findViewById(R.id.M2x31);
		button32=(Button)findViewById(R.id.M2x32);
		button33=(Button)findViewById(R.id.M2x33);
		button34=(Button)findViewById(R.id.M2x34);
		button35=(Button)findViewById(R.id.M2x35);
		button36=(Button)findViewById(R.id.M2x36);
...
//		zaman geri sayým
		  ...
		  Random r=new Random(); //random sýnýfý
	        ...
	        String gelensayi = a + "";				        
	        test36.setText(gelensayi);	
	        
	    	tscore36=(TextView)findViewById(R.id.score36);			 
	    	sharedPreference = new SharedPreference();
			topscore = sharedPreference.getValue(context);	
		    tscore36.setText(String.valueOf(topscore));

		    restart36=(Button)findViewById(R.id.restart36);
	        restart36.setOnClickListener(new View.OnClickListener() {			
	        	@Override
	        ...
	        //Ana menuye donus
		       Button back=(Button)findViewById(R.id.back36);
...
public void onClick(View v) {	
	...
	if(a == b1topdegeri)
	{
		sayac++;
		score36=score36+30;
		stopscore=score36+topscore+"";
		tscore36.setText(stopscore);
...
public void onClick(View v) {
	...
	// 2.katman
		...
		{
				týk27=1;
				button27.setBackgroundResource(R.drawable.besyuzkatman);
				score36=score36+10;
				stopscore=score36+topscore+"";
				tscore36.setText(stopscore);
				 if(sayac<36){
...
public void onClick(View v) {
	...
	// 2.katman
		...
		//fýrsat benzer 1. katman
				...
				{
					týk28=2;
					button28.setBackgroundResource(R.drawable.besyuz);
					score36=score36+10;
					stopscore=score36+topscore+"";
					tscore36.setText(stopscore);
					 if(sayac<36){
				...
				{
						týk28=1;
						button28.setBackgroundResource(R.drawable.besyuzkatman);
						score36=score36+10;
						stopscore=score36+topscore+"";
						tscore36.setText(stopscore);
						 if(sayac<36){
...
public void onClick(View v) {
	...
	// 2.katman
		...
		//fýrsat benzer 1. katman
				...
				{
					týk33=2;
					button33.setBackgroundResource(R.drawable.besyuzsari);
					score36=score36+20;
					stopscore=score36+topscore+"";
					tscore36.setText(stopscore);
					 if(sayac<36){
				...
				{
						týk33=1;
						button33.setBackgroundResource(R.drawable.besyuzsarikatman);
						score36=score36+20;
						stopscore=score36+topscore+"";
						tscore36.setText(stopscore);
						 if(sayac<36){
...
public void onClick(View v) {
	...
	// 2.katman
		...
		{
			týk34=2;
			button34.setBackgroundResource(R.drawable.besyuzsari);
			score36=score36+20;
			stopscore=score36+topscore+"";
			tscore36.setText(stopscore);
			 if(sayac<36){
		...
		{
				týk34=1;
				button34.setBackgroundResource(R.drawable.besyuzsarikatman);
				score36=score36+20;
				stopscore=score36+topscore+"";
				tscore36.setText(stopscore);
				 if(sayac<36){
...
if(score36+topscore<0)
{
	...
	private void ScoreAl25() {
		topscore = Integer.parseInt(tscore36.getText().toString().trim());
		// Save the text in SharedPreference
	  	sharedPreference.save(context, topscore,36);
	  	// Save the text in SharedPreference
	    try {
	      Bundle extras = new Bundle();
	      extras.putInt(TOPSCORE, topscore);
