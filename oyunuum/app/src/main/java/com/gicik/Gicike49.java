...
public class Gicike49 extends Activity implements FragmentManager.OnBackStackChangedListener {
	TextView l1,l2,l3,l4,l5,l6,l7,l8,l9,l0;
	  private Handler mHandler = new Handler();
	    private boolean mShowingBack = false;
	MediaPlayer yanlis;
	Button restart49,button1,button2,button3,button4,button5,button6,button7,button8,button9,button10,button11,button12,button13,button14,button15,button16,
...
//	ver
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.gicike49);
...
//
		test49=(TextView)findViewById(R.id.test49);
			
		yanlis=MediaPlayer.create(Gicike49.this,R.raw.yanlis);
		
		button1=(Button)findViewById(R.id.C3x1);
		button2=(Button)findViewById(R.id.C3x2);
		button3=(Button)findViewById(R.id.C3x3);
		button4=(Button)findViewById(R.id.C3x4);
		button5=(Button)findViewById(R.id.C3x5);
		button6=(Button)findViewById(R.id.C3x6);
		button7=(Button)findViewById(R.id.C3x7);
		button8=(Button)findViewById(R.id.C3x8);
		button9=(Button)findViewById(R.id.C3x9);
		button10=(Button)findViewById(R.id.C3x10);
		button11=(Button)findViewById(R.id.C3x11);
		button12=(Button)findViewById(R.id.C3x12);
		button13=(Button)findViewById(R.id.C3x13);
		button14=(Button)findViewById(R.id.C3x14);
		button15=(Button)findViewById(R.id.C3x15);
		button16=(Button)findViewById(R.id.C3x16);
		button17=(Button)findViewById(R.id.C3x17);
		button18=(Button)findViewById(R.id.C3x18);
		button19=(Button)findViewById(R.id.C3x19);
		button20=(Button)findViewById(R.id.C3x20);
		button21=(Button)findViewById(R.id.C3x21);
		button22=(Button)findViewById(R.id.C3x22);
		button23=(Button)findViewById(R.id.C3x23);
		button24=(Button)findViewById(R.id.C3x24);
		button25=(Button)findViewById(R.id.C3x25);
		button26=(Button)findViewById(R.id.C3x26);
		button27=(Button)findViewById(R.id.C3x27);
		button28=(Button)findViewById(R.id.C3x28);
		button29=(Button)findViewById(R.id.C3x29);
		button30=(Button)findViewById(R.id.C3x30);
		button31=(Button)findViewById(R.id.C3x31);
		button32=(Button)findViewById(R.id.C3x32);
		button33=(Button)findViewById(R.id.C3x33);
		button34=(Button)findViewById(R.id.C3x34);
		button35=(Button)findViewById(R.id.C3x35);
		button36=(Button)findViewById(R.id.C3x36);
		button37=(Button)findViewById(R.id.C3x37);
		button38=(Button)findViewById(R.id.C3x38);
		button39=(Button)findViewById(R.id.C3x39);
		button40=(Button)findViewById(R.id.C3x40);
		button41=(Button)findViewById(R.id.C3x41);
		button42=(Button)findViewById(R.id.C3x42);
...
//		zaman geri sayým
		  ...
		  Random r=new Random(); //random sýnýfý
	        ...
	        String gelensayi = a + "";				        
	        test49.setText(gelensayi);	
	        
	    	tscore49=(TextView)findViewById(R.id.score49);			 
	    	sharedPreference = new SharedPreference();
			topscore = sharedPreference.getValue(context);	
		    tscore49.setText(String.valueOf(topscore));

		    restart49=(Button)findViewById(R.id.restart49);
	        restart49.setOnClickListener(new View.OnClickListener() {			
	        	@Override
	      ...
	      //Ana menuye donus
		       Button back=(Button)findViewById(R.id.back49);
	        ...
	        button1.setOnClickListener(new View.OnClickListener() {			
	        	...
	        	public void onClick(View v) {	
	        		...
	        		if(týk1==4 && a == b1topdegeri){
	        			sayac++;
	        			score49=score49+50;
	        			stopscore=score49+topscore+"";
	        			tscore49.setText(stopscore);
	        		...
	        		{
	        			týk1=3;
	        			button1.setBackgroundResource(R.drawable.besyuzmor);
	        			score49=score49+50;
	        			stopscore=score49+topscore+"";
	        			tscore49.setText(stopscore);
	        			 if(sayac<42){
	        		...
	        		{
	        			týk1=2;
	        			button1.setBackgroundResource(R.drawable.besyuzmorkatman);
	        			score49=score49+50;
	        			stopscore=score49+topscore+"";
	        			tscore49.setText(stopscore);
	        			 if(sayac<42){
	        		...
	        		{
	        				týk1=1;
	        				button1.setBackgroundResource(R.drawable.besyuzmorkatman2);
	        				score49=score49+50;
	        				stopscore=score49+topscore+"";
	        				tscore49.setText(stopscore);
	        				 if(sayac<42){
	        	...
	        	if(sayac<42){
	        		Random r=new Random(); //random sýnýfý
	        		  ...
	        		  ScoreAl25();
	        			...
	        			{
	        					týk2=1;
	        					button2.setBackgroundResource(R.drawable.besyuzmorkatman2);
	        					score49=score49+50;
	        					stopscore=score49+topscore+"";
	        					tscore49.setText(stopscore);
	        					 if(sayac<42){
	        	...
	        	public void onClick(View v) {	
	        		...
	        		// 2.katman
	        			...
	        			{
	        					týk3=1;
	        					button3.setBackgroundResource(R.drawable.besyuzmorkatman2);
	        					score49=score49+50;
	        					stopscore=score49+topscore+"";
	        					tscore49.setText(stopscore);
	        					 if(sayac<42){
	        				...
	        				if(týk4==4 && a == b4topdegeri)
	        		{
	        			...
	        			b42topdegeri--;
	        			 if(sayac<42){
	        				...
	        				{
	        						týk4=1;
	        						button4.setBackgroundResource(R.drawable.besyuzmorkatman2);
	        						score49=score49+50;
	        						stopscore=score49+topscore+"";
	        						tscore49.setText(stopscore);
	        						 if(sayac<42){
	        	...
	        	public void onClick(View v) {	
	        		...
	        		//fýrsat benzer 1. katman
	        				...
	        				{
	        						týk5=1;
	        						button5.setBackgroundResource(R.drawable.besyuzmorkatman2);
	        						score49=score49+50;
	        						stopscore=score49+topscore+"";
	        						tscore49.setText(stopscore);
	        						 if(sayac<42){
	        	...
	        	public void onClick(View v) {	
	        		...
	        		// 2.katman
	        			...
	        			//fýrsat benzer 1. katman
	        					...
	        					{
	        						týk6=3;
	        						button6.setBackgroundResource(R.drawable.besyuzmor);
	        						score49=score49+50;
	        						stopscore=score49+topscore+"";
	        						tscore49.setText(stopscore);
	        						 if(sayac<42){
	        					...
	        					{
	        						týk6=2;
	        						button6.setBackgroundResource(R.drawable.besyuzmorkatman);
	        						score49=score49+50;
	        						stopscore=score49+topscore+"";
	        						tscore49.setText(stopscore);
	        						 if(sayac<42){
	        					...
	        					{
	        							týk6=1;
	        							button6.setBackgroundResource(R.drawable.besyuzmorkatman2);
	        							score49=score49+50;
	        							stopscore=score49+topscore+"";
	        							tscore49.setText(stopscore);
	        							 if(sayac<42){
	        	...
	        	public void onClick(View v) {	
	        		...
	        		// 2.katman
	        			...
	        			//fýrsat benzer 1. katman
	        					...
	        					{
	        							týk7=1;
	        							button7.setBackgroundResource(R.drawable.besyuzmorkatman2);
	        							score49=score49+50;
	        							stopscore=score49+topscore+"";
	        							tscore49.setText(stopscore);
	        							 if(sayac<42){
	        	...
	        	public void onClick(View v) {		
	        		...
	        		// 2.katman
	        			...
	        			//fýrsat benzer 1. katman
	        					...
	        					{
	        							týk8=1;
	        							button8.setBackgroundResource(R.drawable.besyuzmorkatman2);
	        							score49=score49+50;
	        							stopscore=score49+topscore+"";
	        							tscore49.setText(stopscore);
	        							 if(sayac<42){
	        	...
	        	public void onClick(View v) {	
	        		...
	        		// 2.katman
	        			...
	        			//fýrsat benzer 1. katman
	        					...
	        					{
	        							týk9=1;
	        							button9.setBackgroundResource(R.drawable.besyuzmorkatman2);
	        							score49=score49+50;
	        							stopscore=score49+topscore+"";
	        							tscore49.setText(stopscore);
	        							 if(sayac<42){
	        	...
	        	public void onClick(View v) {
	        		...
	        		// 2.katman
	        			...
	        			//fýrsat benzer 1. katman
	        					...
	        					{
	        							týk10=1;
	        							button10.setBackgroundResource(R.drawable.besyuzmorkatman2);
	        							score49=score49+50;
	        							stopscore=score49+topscore+"";
	        							tscore49.setText(stopscore);
	        							 if(sayac<42){
	        		...
	        		// 2.katman
	        			...
	        			b42topdegeri--;
	        			 if(sayac<42){
	        				...
	        				{
	        						týk11=1;
	        						button11.setBackgroundResource(R.drawable.besyuzmorkatman2);
	        						score49=score49+50;
	        						stopscore=score49+topscore+"";
	        						tscore49.setText(stopscore);
	        						 if(sayac<42){
	        		...
	        		// 2.katman
	        			...
	        			b42topdegeri--;
	        			 if(sayac<42){
	        				...
	        				{
	        						týk12=1;
	        						button12.setBackgroundResource(R.drawable.besyuzmorkatman2);
	        						score49=score49+50;
	        						stopscore=score49+topscore+"";
	        						tscore49.setText(stopscore);
	        						 if(sayac<42){
	        		...
	        		// 2.katman
	        			...
	        			b42topdegeri--;
	        			 if(sayac<42){
	        				...
	        				{
	        						týk13=1;
	        						button13.setBackgroundResource(R.drawable.besyuzmorkatman2);
	        						score49=score49+50;
	        						stopscore=score49+topscore+"";
	        						tscore49.setText(stopscore);
	        						 if(sayac<42){
	        		...
	        		// 2.katman
	        			...
	        			b42topdegeri--;
	        			 if(sayac<42){
	        				...
	        				{
	        						týk14=1;
	        						button14.setBackgroundResource(R.drawable.besyuzmorkatman2);
	        						score49=score49+50;
	        						stopscore=score49+topscore+"";
	        						tscore49.setText(stopscore);
	        						 if(sayac<42){
	        		...
	        		// 2.katman
	        			...
	        			b42topdegeri--;
	        			 if(sayac<42){
	        				...
	        				{
	        						týk15=1;
	        						button15.setBackgroundResource(R.drawable.besyuzmorkatman2);
	        						score49=score49+50;
	        						stopscore=score49+topscore+"";
	        						tscore49.setText(stopscore);
	        						 if(sayac<42){
	        		...
	        		// 2.katman
	        			...
	        			b42topdegeri--;
	        			 if(sayac<42){
	        				...
	        				{
	        						týk16=1;
	        						button16.setBackgroundResource(R.drawable.besyuzmorkatman2);
	        						score49=score49+50;
	        						stopscore=score49+topscore+"";
	        						tscore49.setText(stopscore);
	        						 if(sayac<42){
	        		...
	        		// 2.katman
	        			...
	        			b42topdegeri--;
	        			 if(sayac<42){
	        				...
	        				{
	        						týk17=1;
	        						button17.setBackgroundResource(R.drawable.besyuzmorkatman2);
	        						score49=score49+50;
	        						stopscore=score49+topscore+"";
	        						tscore49.setText(stopscore);
	        						 if(sayac<42){
	        		...
	        		// 2.katman
	        			...
	        			b42topdegeri--;
	        			 if(sayac<42){
	        				...
	        				{
	        						týk18=1;
	        						button18.setBackgroundResource(R.drawable.besyuzmorkatman2);
	        						score49=score49+50;
	        						stopscore=score49+topscore+"";
	        						tscore49.setText(stopscore);
	        						 if(sayac<42){
	        		...
	        		// 2.katman
	        			...
	        			b42topdegeri--;
	        			 if(sayac<42){
	        				...
	        				{
	        						týk19=1;
	        						button19.setBackgroundResource(R.drawable.besyuzmorkatman2);
	        						score49=score49+50;
	        						stopscore=score49+topscore+"";
	        						tscore49.setText(stopscore);
	        						 if(sayac<42){
	        		...
	        		// 2.katman
	        			...
	        			b42topdegeri--;
	        			 if(sayac<42){
	        				...
	        				{
	        						týk20=1;
	        						button20.setBackgroundResource(R.drawable.besyuzmorkatman2);
	        						score49=score49+50;
	        						stopscore=score49+topscore+"";
	        						tscore49.setText(stopscore);
	        						 if(sayac<42){
	        		...
	        		// 2.katman
	        			...
	        			b42topdegeri--;
	        			 if(sayac<42){
	        				...
	        				{
	        						týk21=1;
	        						button21.setBackgroundResource(R.drawable.besyuzmorkatman2);
	        						score49=score49+50;
	        						stopscore=score49+topscore+"";
	        						tscore49.setText(stopscore);
	        						 if(sayac<42){
	        			...
	        			b42topdegeri--;
	        			 if(sayac<42){
	        				 ...
	        				 ScoreAl25();
	        					...
	        					{
	        							týk22=1;
	        							button22.setBackgroundResource(R.drawable.besyuzmorkatman2);
	        							score49=score49+50;
	        							stopscore=score49+topscore+"";
	        							tscore49.setText(stopscore);
	        							 if(sayac<42){
	        			...
	        			b42topdegeri--;
	        			 if(sayac<42){
	        				 ...
	        				 ScoreAl25();
	        					...
	        					{
	        							týk23=1;
	        							button23.setBackgroundResource(R.drawable.besyuzmorkatman2);
	        							score49=score49+50;
	        							stopscore=score49+topscore+"";
	        							tscore49.setText(stopscore);
	        							 if(sayac<42){
	        			...
	        			b42topdegeri--;
	        			 if(sayac<42){
	        				 ...
	        				 ScoreAl25();
	        					...
	        					{
	        							týk24=1;
	        							button24.setBackgroundResource(R.drawable.besyuzmorkatman2);
	        							score49=score49+50;
	        							stopscore=score49+topscore+"";
	        							tscore49.setText(stopscore);
	        							 if(sayac<42){
	        			...
	        			b42topdegeri--;
	        			 ...
	        			 if(sayac<42){
	        				 ...
	        				 ScoreAl25();
	        					...
	        					{
	        							týk25=1;
	        							button25.setBackgroundResource(R.drawable.besyuzmorkatman2);
	        							score49=score49+50;
	        							stopscore=score49+topscore+"";
	        							tscore49.setText(stopscore);
	        							 if(sayac<42){
	        			...
	        			b42topdegeri--;
	        			 ...
	        			 if(sayac<42){
	        				 ...
	        				 ScoreAl25();
	        					...
	        					{
	        							týk26=1;
	        							button26.setBackgroundResource(R.drawable.besyuzmorkatman2);
	        							score49=score49+50;
	        							stopscore=score49+topscore+"";
	        							tscore49.setText(stopscore);
	        							 if(sayac<42){
	        			...
	        			b42topdegeri--;
	        			 ...
	        			 if(sayac<42){
	        				 ...
	        				 ScoreAl25();
	        					...
	        					{
	        							týk27=1;
	        							button27.setBackgroundResource(R.drawable.besyuzmorkatman2);
	        							score49=score49+50;
	        							stopscore=score49+topscore+"";
	        							tscore49.setText(stopscore);
	        							 if(sayac<42){
	        			...
	        			b42topdegeri--;
	        			 ...
	        			 if(sayac<42){
	        				 ...
	        				 ScoreAl25();
	        					...
	        					{
	        							týk28=1;
	        							button28.setBackgroundResource(R.drawable.besyuzmorkatman2);
	        							score49=score49+50;
	        							stopscore=score49+topscore+"";
	        							tscore49.setText(stopscore);
	        							 if(sayac<42){
	        			...
	        			b42topdegeri--;
	        			 ...
	        			 if(sayac<42){
	        				 ...
	        				 ScoreAl25();
	        					...
	        					{
	        							týk29=1;
	        							button29.setBackgroundResource(R.drawable.besyuzmorkatman2);
	        							score49=score49+50;
	        							stopscore=score49+topscore+"";
	        							tscore49.setText(stopscore);
	        							 if(sayac<42){
	        			...
	        			b42topdegeri--;
	        			 ...
	        			 if(sayac<42){
	        				 ...
	        				 ScoreAl25();
	        					...
	        					{
	        							týk30=1;
	        							button30.setBackgroundResource(R.drawable.besyuzmorkatman2);
	        							score49=score49+50;
	        							stopscore=score49+topscore+"";
	        							tscore49.setText(stopscore);
	        							 if(sayac<42){
	        	...
	        	public void onClick(View v) {
	        		...
	        		{
	        				týk31=1;
	        				button31.setBackgroundResource(R.drawable.besyuzmorkatman2);
	        				score49=score49+50;
	        				stopscore=score49+topscore+"";
	        				tscore49.setText(stopscore);
	        				 if(sayac<42){
	        	...
	        	public void onClick(View v) {
	        		...
	        		{
	        				týk32=1;
	        				button32.setBackgroundResource(R.drawable.besyuzmorkatman2);
	        				score49=score49+50;
	        				stopscore=score49+topscore+"";
	        				tscore49.setText(stopscore);
	        				 if(sayac<42){
	        	...
	        	public void onClick(View v) {
	        		...
	        		{
	        				týk33=1;
	        				button33.setBackgroundResource(R.drawable.besyuzmorkatman2);
	        				score49=score49+50;
	        				stopscore=score49+topscore+"";
	        				tscore49.setText(stopscore);
	        				 if(sayac<42){
	        	...
	        	public void onClick(View v) {
	        		...
	        		{
	        				týk34=1;
	        				button34.setBackgroundResource(R.drawable.besyuzmorkatman2);
	        				score49=score49+50;
	        				stopscore=score49+topscore+"";
	        				tscore49.setText(stopscore);
	        				 if(sayac<42){
	        	...
	        	public void onClick(View v) {
	        		...
	        		{
	        				týk35=1;
	        				button35.setBackgroundResource(R.drawable.besyuzmorkatman2);
	        				score49=score49+50;
	        				stopscore=score49+topscore+"";
	        				tscore49.setText(stopscore);
	        				 if(sayac<42){
	        	...
	        	public void onClick(View v) {
	        		...
	        		{
	        				týk36=1;
	        				button36.setBackgroundResource(R.drawable.besyuzmorkatman2);
	        				score49=score49+50;
	        				stopscore=score49+topscore+"";
	        				tscore49.setText(stopscore);
	        				 if(sayac<42){
	        	...
	        	public void onClick(View v) {
	        		...
	        		{
	        			týk37=3;
	        			button37.setBackgroundResource(R.drawable.besyuzmor);
	        			score49=score49+50;
	        			stopscore=score49+topscore+"";
	        			tscore49.setText(stopscore);
	        			 if(sayac<42){
	        		...
	        		{
	        			týk37=2;
	        			button37.setBackgroundResource(R.drawable.besyuzmorkatman);
	        			score49=score49+50;
	        			stopscore=score49+topscore+"";
	        			tscore49.setText(stopscore);
	        			 if(sayac<42){
	        		...
	        		{
	        				týk37=1;
	        				button37.setBackgroundResource(R.drawable.besyuzmorkatman2);
	        				score49=score49+50;
	        				stopscore=score49+topscore+"";
	        				tscore49.setText(stopscore);
	        				 if(sayac<42){
	        	...
	        	public void onClick(View v) {
	        		...
	        		{
	        			týk38=3;
	        			button38.setBackgroundResource(R.drawable.besyuzmor);
	        			score49=score49+50;
	        			stopscore=score49+topscore+"";
	        			tscore49.setText(stopscore);
	        			 if(sayac<42){
	        		...
	        		{
	        			týk38=2;
	        			button38.setBackgroundResource(R.drawable.besyuzmorkatman);
	        			score49=score49+50;
	        			stopscore=score49+topscore+"";
	        			tscore49.setText(stopscore);
	        			 if(sayac<42){
	        		...
	        		{
	        				týk38=1;
	        				button38.setBackgroundResource(R.drawable.besyuzmorkatman2);
	        				score49=score49+50;
	        				stopscore=score49+topscore+"";
	        				tscore49.setText(stopscore);
	        				 if(sayac<42){
	        	...
	        	public void onClick(View v) {
	        		...
	        		{
	        			týk39=3;
	        			button39.setBackgroundResource(R.drawable.besyuzmor);
	        			score49=score49+50;
	        			stopscore=score49+topscore+"";
	        			tscore49.setText(stopscore);
	        			 if(sayac<42){
	        		...
	        		{
	        			týk39=2;
	        			button39.setBackgroundResource(R.drawable.besyuzmorkatman);
	        			score49=score49+50;
	        			stopscore=score49+topscore+"";
	        			tscore49.setText(stopscore);
	        			 if(sayac<42){
	        		...
	        		{
	        				týk39=1;
	        				button39.setBackgroundResource(R.drawable.besyuzmorkatman2);
	        				score49=score49+50;
	        				stopscore=score49+topscore+"";
	        				tscore49.setText(stopscore);
	        				 if(sayac<42){
	        	...
	        	public void onClick(View v) {
	        		...
	        		{
	        			týk40=3;
	        			button40.setBackgroundResource(R.drawable.besyuzmor);
	        			score49=score49+50;
	        			stopscore=score49+topscore+"";
	        			tscore49.setText(stopscore);
	        			 if(sayac<42){
	        		...
	        		{
	        			týk40=2;
	        			button40.setBackgroundResource(R.drawable.besyuzmorkatman);
	        			score49=score49+50;
	        			stopscore=score49+topscore+"";
	        			tscore49.setText(stopscore);
	        			 if(sayac<42){
	        		...
	        		{
	        				týk40=1;
	        				button40.setBackgroundResource(R.drawable.besyuzmorkatman2);
	        				score49=score49+50;
	        				stopscore=score49+topscore+"";
	        				tscore49.setText(stopscore);
	        				 if(sayac<42){
	        	...
	        	public void onClick(View v) {
	        		...
	        		// 2.katman
	        			...
	        			{
	        				týk41=3;
	        				button41.setBackgroundResource(R.drawable.besyuzmor);
	        				score49=score49+50;
	        				stopscore=score49+topscore+"";
	        				tscore49.setText(stopscore);
	        				 if(sayac<42){
	        			...
	        			{
	        				týk41=2;
	        				button41.setBackgroundResource(R.drawable.besyuzmorkatman);
	        				score49=score49+50;
	        				stopscore=score49+topscore+"";
	        				tscore49.setText(stopscore);
	        				 if(sayac<42){
	        			...
	        			{
	        					týk41=1;
	        					button41.setBackgroundResource(R.drawable.besyuzmorkatman2);
	        					score49=score49+50;
	        					stopscore=score49+topscore+"";
	        					tscore49.setText(stopscore);
	        					 if(sayac<42){
	        	...
	        	public void onClick(View v) {
	        		...
	        		// 2.katman
	        			...
	        			{
	        				týk42=3;
	        				button42.setBackgroundResource(R.drawable.besyuzmor);
	        				score49=score49+50;
	        				stopscore=score49+topscore+"";
	        				tscore49.setText(stopscore);
	        				 if(sayac<42){
	        			...
	        			{
	        				týk42=2;
	        				button42.setBackgroundResource(R.drawable.besyuzmorkatman);
	        				score49=score49+50;
	        				stopscore=score49+topscore+"";
	        				tscore49.setText(stopscore);
	        				 if(sayac<42){
	        			...
	        			{
	        					týk42=1;
	        					button42.setBackgroundResource(R.drawable.besyuzmorkatman2);
	        					score49=score49+50;
	        					stopscore=score49+topscore+"";
	        					tscore49.setText(stopscore);
	        					 if(sayac<42){
...
if(score49+topscore<0)
{
	...
	private void ScoreAl25() {
		topscore = Integer.parseInt(tscore49.getText().toString().trim());
		// Save the text in SharedPreference
	  	sharedPreference.save(context, topscore,49);
	  	// Save the text in SharedPreference
	    try {
	      Bundle extras = new Bundle();
	      extras.putInt(TOPSCORE, topscore);
