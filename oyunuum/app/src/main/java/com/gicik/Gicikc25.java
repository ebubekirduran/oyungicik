...
public class Gicikc25 extends Activity implements FragmentManager.OnBackStackChangedListener {
	TextView l1,l2,l3,l4,l5,l6,l7,l8,l9,l0;
	  private Handler mHandler = new Handler();
	    private boolean mShowingBack = false;
	MediaPlayer yanlis;
	Button restart25,button1,button2,button3,button4,button5,button6,button7,button8,button9,button10,button11,button12,button13,button14,button15,button16,
...
//	ver
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.gicikc25);
   ...
   //animasyon		
   	...
   	//
		test25=(TextView)findViewById(R.id.test25);
			
		yanlis=MediaPlayer.create(Gicikc25.this,R.raw.yanlis);
		
		button1=(Button)findViewById(R.id.B2x1);
		button2=(Button)findViewById(R.id.B2x2);
		button3=(Button)findViewById(R.id.B2x3);
		button4=(Button)findViewById(R.id.B2x4);
		button5=(Button)findViewById(R.id.B2x5);
		button6=(Button)findViewById(R.id.B2x6);
		button7=(Button)findViewById(R.id.B2x7);
		button8=(Button)findViewById(R.id.B2x8);
		button9=(Button)findViewById(R.id.B2x9);
		button10=(Button)findViewById(R.id.B2x10);
		button11=(Button)findViewById(R.id.B2x11);
		button12=(Button)findViewById(R.id.B2x12);
		button13=(Button)findViewById(R.id.B2x13);
		button14=(Button)findViewById(R.id.B2x14);
		button15=(Button)findViewById(R.id.B2x15);
		button16=(Button)findViewById(R.id.B2x16);
		button17=(Button)findViewById(R.id.B2x17);
		button18=(Button)findViewById(R.id.B2x18);
		button19=(Button)findViewById(R.id.B2x19);
		button20=(Button)findViewById(R.id.B2x20);
		button21=(Button)findViewById(R.id.B2x21);
		button22=(Button)findViewById(R.id.B2x22);
		button23=(Button)findViewById(R.id.B2x23);
		button24=(Button)findViewById(R.id.B2x24);
		button25=(Button)findViewById(R.id.B2x25);
...
//		zaman geri sayým
		  ...
		  Random r=new Random(); //random sýnýfý
	        ...
	        String gelensayi = a + "";				        
	        test25.setText(gelensayi);	
	        
	    	tscore25=(TextView)findViewById(R.id.score25);			 
	    	sharedPreference = new SharedPreference();
			topscore = sharedPreference.getValue(context);	
		    tscore25.setText(String.valueOf(topscore));

		    restart25=(Button)findViewById(R.id.restart25);
	        restart25.setOnClickListener(new View.OnClickListener() {			
	        	@Override
	        ...
	        //Ana menuye donus
		       Button back=(Button)findViewById(R.id.back25);
...
public void onClick(View v) {	
	...
	//fýrsat benzer 
		...
		if(týk1>=2 && a == b1topdegeri)
		{
			sayac++;
		score25=score25+10;
		stopscore=score25+topscore+"";
		tscore25.setText(stopscore);
...
public void onClick(View v) {
	...
	private void ScoreAl25() {
		topscore = Integer.parseInt(tscore25.getText().toString().trim());
		// Save the text in SharedPreference
	  	sharedPreference.save(context, topscore,25);
	  	// Save the text in SharedPreference
	    try {
	      Bundle extras = new Bundle();
	      extras.putInt(TOPSCORE, topscore);
