...
public class Gicikc28 extends Activity implements FragmentManager.OnBackStackChangedListener {
	TextView l1,l2,l3,l4,l5,l6,l7,l8,l9,l0;
	  private Handler mHandler = new Handler();
	    private boolean mShowingBack = false;
	MediaPlayer yanlis;
	Button restart28,button1,button2,button3,button4,button5,button6,button7,button8,button9,button10,button11,button12,button13,button14,button15,button16,
...
//	ver
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.gicikc28);
...
//
		test28=(TextView)findViewById(R.id.test28);
			
		yanlis=MediaPlayer.create(Gicikc28.this,R.raw.yanlis);
		
		button1=(Button)findViewById(R.id.E2x1);
		button2=(Button)findViewById(R.id.E2x2);
		button3=(Button)findViewById(R.id.E2x3);
		button4=(Button)findViewById(R.id.E2x4);
		button5=(Button)findViewById(R.id.E2x5);
		button6=(Button)findViewById(R.id.E2x6);
		button7=(Button)findViewById(R.id.E2x7);
		button8=(Button)findViewById(R.id.E2x8);
		button9=(Button)findViewById(R.id.E2x9);
		button10=(Button)findViewById(R.id.E2x10);
		button11=(Button)findViewById(R.id.E2x11);
		button12=(Button)findViewById(R.id.E2x12);
		button13=(Button)findViewById(R.id.E2x13);
		button14=(Button)findViewById(R.id.E2x14);
		button15=(Button)findViewById(R.id.E2x15);
		button16=(Button)findViewById(R.id.E2x16);
		button17=(Button)findViewById(R.id.E2x17);
		button18=(Button)findViewById(R.id.E2x18);
		button19=(Button)findViewById(R.id.E2x19);
		button20=(Button)findViewById(R.id.E2x20);
		button21=(Button)findViewById(R.id.E2x21);
		button22=(Button)findViewById(R.id.E2x22);
		button23=(Button)findViewById(R.id.E2x23);
		button24=(Button)findViewById(R.id.E2x24);
		button25=(Button)findViewById(R.id.E2x25);
...
//		zaman geri sayým
		  ...
		  Random r=new Random(); //random sýnýfý
	        ...
	        String gelensayi = a + "";				        
	        test28.setText(gelensayi);	
	        
	    	tscore28=(TextView)findViewById(R.id.score28);			 
	    	sharedPreference = new SharedPreference();
			topscore = sharedPreference.getValue(context);	
		    tscore28.setText(String.valueOf(topscore));

		    restart28=(Button)findViewById(R.id.restart28);
	        restart28.setOnClickListener(new View.OnClickListener() {			
	        	@Override
	        ...
	        //Ana menuye donus
		       Button back=(Button)findViewById(R.id.back28);
...
public void onClick(View v) {	
	...
	if(a == b1topdegeri)
	{
		sayac++;
		score28=score28+10;
		stopscore=score28+topscore+"";
		tscore28.setText(stopscore);
...
public void onClick(View v) {	
	...
	{
			týk7=1;
			button7.setBackgroundResource(R.drawable.besyuzsarikatman);
			score28=score28+20;
			stopscore=score28+topscore+"";
			tscore28.setText(stopscore);
			 if(sayac<25){
...
public void onClick(View v) {	
	...
	// 2.katman
		...
		{
				týk9=1;
				button9.setBackgroundResource(R.drawable.besyuzsarikatman);
				score28=score28+20;
				stopscore=score28+topscore+"";
				tscore28.setText(stopscore);
				 if(sayac<25){
	...
	// 2.katman
		...
		b25topdegeri--;
		 if(sayac<25){
			...
			{
				týk23=2;
				button23.setBackgroundResource(R.drawable.besyuzsari);
				score28=score28+20;
				stopscore=score28+topscore+"";
				tscore28.setText(stopscore);
				 if(sayac<25){
			...
			{
					týk23=1;
					button23.setBackgroundResource(R.drawable.besyuzsarikatman);
					score28=score28+20;
					stopscore=score28+topscore+"";
					tscore28.setText(stopscore);
					 if(sayac<25){
...
if(score28+topscore<0)
{
	...
	private void ScoreAl25() {
		topscore = Integer.parseInt(tscore28.getText().toString().trim());
		// Save the text in SharedPreference
	  	sharedPreference.save(context, topscore,28);
	  	// Save the text in SharedPreference
	    try {
	      Bundle extras = new Bundle();
	      extras.putInt(TOPSCORE, topscore);
