...
public class Gicikc27 extends Activity implements FragmentManager.OnBackStackChangedListener {
	TextView l1,l2,l3,l4,l5,l6,l7,l8,l9,l0;
	  private Handler mHandler = new Handler();
	    private boolean mShowingBack = false;
	MediaPlayer yanlis;
	Button restart27,button1,button2,button3,button4,button5,button6,button7,button8,button9,button10,button11,button12,button13,button14,button15,button16,
...
//	ver
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.gicikc27);
...
//
		test27=(TextView)findViewById(R.id.test27);
			
		yanlis=MediaPlayer.create(Gicikc27.this,R.raw.yanlis);
		
		button1=(Button)findViewById(R.id.D2x1);
		button2=(Button)findViewById(R.id.D2x2);
		button3=(Button)findViewById(R.id.D2x3);
		button4=(Button)findViewById(R.id.D2x4);
		button5=(Button)findViewById(R.id.D2x5);
		button6=(Button)findViewById(R.id.D2x6);
		button7=(Button)findViewById(R.id.D2x7);
		button8=(Button)findViewById(R.id.D2x8);
		button9=(Button)findViewById(R.id.D2x9);
		button10=(Button)findViewById(R.id.D2x10);
		button11=(Button)findViewById(R.id.D2x11);
		button12=(Button)findViewById(R.id.D2x12);
		button13=(Button)findViewById(R.id.D2x13);
		button14=(Button)findViewById(R.id.D2x14);
		button15=(Button)findViewById(R.id.D2x15);
		button16=(Button)findViewById(R.id.D2x16);
		button17=(Button)findViewById(R.id.D2x17);
		button18=(Button)findViewById(R.id.D2x18);
		button19=(Button)findViewById(R.id.D2x19);
		button20=(Button)findViewById(R.id.D2x20);
		button21=(Button)findViewById(R.id.D2x21);
		button22=(Button)findViewById(R.id.D2x22);
		button23=(Button)findViewById(R.id.D2x23);
		button24=(Button)findViewById(R.id.D2x24);
		button25=(Button)findViewById(R.id.D2x25);
...
//		zaman geri sayým
		  ...
		  Random r=new Random(); //random sýnýfý
	        ...
	        String gelensayi = a + "";				        
	        test27.setText(gelensayi);	
	        
	    	tscore27=(TextView)findViewById(R.id.score27);			 
	    	sharedPreference = new SharedPreference();
			topscore = sharedPreference.getValue(context);	
		    tscore27.setText(String.valueOf(topscore));

		    restart27=(Button)findViewById(R.id.restart27);
	        restart27.setOnClickListener(new View.OnClickListener() {			
	        	@Override
	        ...
	        //Ana menuye donus
		       Button back=(Button)findViewById(R.id.back27);
...
public void onClick(View v) {	
	...
	if(a == b1topdegeri)
	{
		sayac++;
		score27=score27+10;
		stopscore=score27+topscore+"";
		tscore27.setText(stopscore);
...
public void onClick(View v) {
 ...
 if(score27+topscore<0)
 {
	...
	private void ScoreAl25() {
		topscore = Integer.parseInt(tscore27.getText().toString().trim());
		// Save the text in SharedPreference
	  	sharedPreference.save(context, topscore,27);
	  	// Save the text in SharedPreference
	    try {
	      Bundle extras = new Bundle();
	      extras.putInt(TOPSCORE, topscore);
