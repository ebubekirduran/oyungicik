...
public class Gicikd37 extends Activity implements FragmentManager.OnBackStackChangedListener {
	TextView l1,l2,l3,l4,l5,l6,l7,l8,l9,l0;
	  private Handler mHandler = new Handler();
	    private boolean mShowingBack = false;
	MediaPlayer yanlis;
	Button restart37,button1,button2,button3,button4,button5,button6,button7,button8,button9,button10,button11,button12,button13,button14,button15,button16,
...
//	ver
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.gicikd37);
...
//
		test37=(TextView)findViewById(R.id.test37);
			
		yanlis=MediaPlayer.create(Gicikd37.this,R.raw.yanlis);
		
		button1=(Button)findViewById(R.id.N2x1);
		button2=(Button)findViewById(R.id.N2x2);
		button3=(Button)findViewById(R.id.N2x3);
		button4=(Button)findViewById(R.id.N2x4);
		button5=(Button)findViewById(R.id.N2x5);
		button6=(Button)findViewById(R.id.N2x6);
		button7=(Button)findViewById(R.id.N2x7);
		button8=(Button)findViewById(R.id.N2x8);
		button9=(Button)findViewById(R.id.N2x9);
		button10=(Button)findViewById(R.id.N2x10);
		button11=(Button)findViewById(R.id.N2x11);
		button12=(Button)findViewById(R.id.N2x12);
		button13=(Button)findViewById(R.id.N2x13);
		button14=(Button)findViewById(R.id.N2x14);
		button15=(Button)findViewById(R.id.N2x15);
		button16=(Button)findViewById(R.id.N2x16);
		button17=(Button)findViewById(R.id.N2x17);
		button18=(Button)findViewById(R.id.N2x18);
		button19=(Button)findViewById(R.id.N2x19);
		button20=(Button)findViewById(R.id.N2x20);
		button21=(Button)findViewById(R.id.N2x21);
		button22=(Button)findViewById(R.id.N2x22);
		button23=(Button)findViewById(R.id.N2x23);
		button24=(Button)findViewById(R.id.N2x24);
		button25=(Button)findViewById(R.id.N2x25);
		button26=(Button)findViewById(R.id.N2x26);
		button27=(Button)findViewById(R.id.N2x27);
		button28=(Button)findViewById(R.id.N2x28);
		button29=(Button)findViewById(R.id.N2x29);
		button30=(Button)findViewById(R.id.N2x30);
		button31=(Button)findViewById(R.id.N2x31);
		button32=(Button)findViewById(R.id.N2x32);
		button33=(Button)findViewById(R.id.N2x33);
		button34=(Button)findViewById(R.id.N2x34);
		button35=(Button)findViewById(R.id.N2x35);
		button36=(Button)findViewById(R.id.N2x36);
...
//		zaman geri sayým
		  ...
		  Random r=new Random(); //random sýnýfý
	        ...
	        String gelensayi = a + "";				        
	        test37.setText(gelensayi);	
	        
	    	tscore37=(TextView)findViewById(R.id.score37);			 
	    	sharedPreference = new SharedPreference();
			topscore = sharedPreference.getValue(context);	
		    tscore37.setText(String.valueOf(topscore));

		    restart37=(Button)findViewById(R.id.restart37);
	        restart37.setOnClickListener(new View.OnClickListener() {			
	        	@Override
	        ...
	        //Ana menuye donus
		       Button back=(Button)findViewById(R.id.back37);
...
public void onClick(View v) {	
	...
	if(a == b1topdegeri)
	{
		sayac++;
		score37=score37+20;
		stopscore=score37+topscore+"";
		tscore37.setText(stopscore);
		...
		b36topdegeri--;
		 if(sayac<36){
			 ...
			 ScoreAl25();
				...
				{
						týk10=1;
						button10.setBackgroundResource(R.drawable.besyuzyesilkatman);
						score37=score37+30;
						stopscore=score37+topscore+"";
						tscore37.setText(stopscore);
						 if(sayac<36){
...
public void onClick(View v) {	
	...
	//fýrsat benzer 1. katman
		...
		{
				týk20=1;
				button20.setBackgroundResource(R.drawable.besyuzyesilkatman);
				score37=score37+30;
				stopscore=score37+topscore+"";
				tscore37.setText(stopscore);
				 if(sayac<36){
...
if(score37+topscore<0)
{
	...
	private void ScoreAl25() {
		topscore = Integer.parseInt(tscore37.getText().toString().trim());
		// Save the text in SharedPreference
	  	sharedPreference.save(context, topscore,37);
	  	// Save the text in SharedPreference
	    try {
	      Bundle extras = new Bundle();
	      extras.putInt(TOPSCORE, topscore);
