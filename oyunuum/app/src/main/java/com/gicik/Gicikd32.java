...
public class Gicikd32 extends Activity implements FragmentManager.OnBackStackChangedListener {
	TextView l1,l2,l3,l4,l5,l6,l7,l8,l9,l0;
	  private Handler mHandler = new Handler();
	    private boolean mShowingBack = false;
	MediaPlayer yanlis;
	Button restart32,button1,button2,button3,button4,button5,button6,button7,button8,button9,button10,button11,button12,button13,button14,button15,button16,
...
//	ver
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.gicikd32);
...
//
		test32=(TextView)findViewById(R.id.test32);
			
		yanlis=MediaPlayer.create(Gicikd32.this,R.raw.yanlis);
		
		button1=(Button)findViewById(R.id.I2x1);
		button2=(Button)findViewById(R.id.I2x2);
		button3=(Button)findViewById(R.id.I2x3);
		button4=(Button)findViewById(R.id.I2x4);
		button5=(Button)findViewById(R.id.I2x5);
		button6=(Button)findViewById(R.id.I2x6);
		button7=(Button)findViewById(R.id.I2x7);
		button8=(Button)findViewById(R.id.I2x8);
		button9=(Button)findViewById(R.id.I2x9);
		button10=(Button)findViewById(R.id.I2x10);
		button11=(Button)findViewById(R.id.I2x11);
		button12=(Button)findViewById(R.id.I2x12);
		button13=(Button)findViewById(R.id.I2x13);
		button14=(Button)findViewById(R.id.I2x14);
		button15=(Button)findViewById(R.id.I2x15);
		button16=(Button)findViewById(R.id.I2x16);
		button17=(Button)findViewById(R.id.I2x17);
		button18=(Button)findViewById(R.id.I2x18);
		button19=(Button)findViewById(R.id.I2x19);
		button20=(Button)findViewById(R.id.I2x20);
		button21=(Button)findViewById(R.id.I2x21);
		button22=(Button)findViewById(R.id.I2x22);
		button23=(Button)findViewById(R.id.I2x23);
		button24=(Button)findViewById(R.id.I2x24);
		button25=(Button)findViewById(R.id.I2x25);
		button26=(Button)findViewById(R.id.I2x26);
		button27=(Button)findViewById(R.id.I2x27);
		button28=(Button)findViewById(R.id.I2x28);
		button29=(Button)findViewById(R.id.I2x29);
		button30=(Button)findViewById(R.id.I2x30);
...
//		zaman geri sayým
		  ...
		  Random r=new Random(); //random sýnýfý
	        ...
	        String gelensayi = a + "";				        
	        test32.setText(gelensayi);	
	        
	    	tscore32=(TextView)findViewById(R.id.score32);			 
	    	sharedPreference = new SharedPreference();
			topscore = sharedPreference.getValue(context);	
		    tscore32.setText(String.valueOf(topscore));

		    restart32=(Button)findViewById(R.id.restart32);
	        restart32.setOnClickListener(new View.OnClickListener() {			
	        	@Override
	        ...
	        //Ana menuye donus
		       Button back=(Button)findViewById(R.id.back32);
...
public void onClick(View v) {	
	...
	if(týk1==3 && a == b1topdegeri){
		sayac++;
		score32=score32+20;
		stopscore=score32+topscore+"";
		tscore32.setText(stopscore);
	...
	{
		týk1=2;
		button1.setBackgroundResource(R.drawable.besyuzsari);
		score32=score32+20;
		stopscore=score32+topscore+"";
		tscore32.setText(stopscore);
		 if(sayac<30){
	...
	{
			týk1=1;
			button1.setBackgroundResource(R.drawable.besyuzsarikatman);
			score32=score32+20;
			stopscore=score32+topscore+"";
			tscore32.setText(stopscore);
			 if(sayac<30){
...
public void onClick(View v) {	
	...
	// 2.katman
		...
		{
				týk12=1;
				button12.setBackgroundResource(R.drawable.besyuzyesilkatman);
				score32=score32+30;
				stopscore=score32+topscore+"";
				tscore32.setText(stopscore);
				 if(sayac<30){
	...
	// 2.katman
		...
		b30topdegeri--;
		 ...
		 if(sayac<30){
			...
			{
				týk26=2;
				button26.setBackgroundResource(R.drawable.besyuzsari);
				score32=score32+20;
				stopscore=score32+topscore+"";
				tscore32.setText(stopscore);
				 if(sayac<30){
			...
			{
					týk26=1;
					button26.setBackgroundResource(R.drawable.besyuzsarikatman);
					score32=score32+20;
					stopscore=score32+topscore+"";
					tscore32.setText(stopscore);
					 if(sayac<30){
	...
	// 2.katman
		...
		button30.setVisibility(View.INVISIBLE);		
		 ...
		 if(sayac<30){
			...
			{
				týk30=2;
				button30.setBackgroundResource(R.drawable.besyuzsari);
				score32=score32+20;
				stopscore=score32+topscore+"";
				tscore32.setText(stopscore);
				 if(sayac<30){
			...
			{
					týk30=1;
					button30.setBackgroundResource(R.drawable.besyuzsarikatman);
					score32=score32+20;
					stopscore=score32+topscore+"";
					tscore32.setText(stopscore);
					 if(sayac<30){
...
if(score32+topscore<0)
{
	...
	private void ScoreAl25() {
		topscore = Integer.parseInt(tscore32.getText().toString().trim());
		// Save the text in SharedPreference
	  	sharedPreference.save(context, topscore,32);
	  	// Save the text in SharedPreference
	    try {
	      Bundle extras = new Bundle();
	      extras.putInt(TOPSCORE, topscore);
